	...
	<script type="text/javascript">
		$(function (){
			...
			$("button.addToCart").click(function (){
				//在时间响应的function函数中，有一个this对象，这个this对象，是当前正在相应事件的dom对象
				//attr设置和获取返回的属性的值
				var bookId=$(this).attr("bookId");
				$.getJSON("http://localhost:8088/new_book/carServlet","action=ajaxAdd&id="+bookId,function (data){
					console.log(data);
		...
		<div id="book">
			...
			<div style="text-align: center">
				<c:if test="${empty sessionScope.cart.items}">
					...
					<div>
					<span id="cartLastName">您的购物车中没有商品</span>
					</div>
				</c:if>
